...
Work through the code chunks sequentially - suggest you do not attempt to knit it (I haven't tested this).
Any issues/questions please email samuel.lipworth@ndm.ox.ac.uk william.matlock@wadham.ox.ac.uk/ twitter @samlipworth @wtmatlock
...
```{r Screen of EUSCAPE short read data}
